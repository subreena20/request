...
navigation=input("Do u want to go next(n)or previous(p): ")
...
if navigation=="n":
    ...
    with open("child.json","w") as f:
        ...
        user_navigation=input("Do you want to go next(n) or previous(p): ")

        
        if user_navigation=="n":
            for l in list1:
